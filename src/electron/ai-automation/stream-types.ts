...
// Discriminated union of all events emitted by `claude --output-format stream-json`
...
// Re-export individual types for use in function signatures
export type {
  StreamAssistantEvent,
  StreamResultEvent,
  StreamSystemEvent,

...
import { getMcpConfigPath } from './mcp-server.js'
...
export async function sendPlannerMessage(
  ...
  return new Promise((resolve, reject) => {
    ...
    const args = [
      ...
      '--allowedTools', 'mcp__devcontrol__create_task,mcp__devcontrol__create_board,mcp__devcontrol__list_knowledge_docs,mcp__devcontrol__read_knowledge_doc,mcp__devcontrol__list_projects',
      '-p', fullPrompt,
    ]

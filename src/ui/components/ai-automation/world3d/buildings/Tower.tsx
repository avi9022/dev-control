...
const GATE_LANTERN_Y = 2.85
const CAMPFIRE_LANTERN_Y = 1.35
const CAMPFIRE_LANTERN_X = 3.5
const CORNER_LANTERN_Y = 2.85
const GATE_Z_OFFSET = 6
const CORNER_Z_OFFSET = -3
const CAMPFIRE_Z_OFFSET = 1
...
export const Tower: FC<TowerProps> = ({ position, color }) => {
  ...
  return (
    <group>
      ...
      <Lantern position={[x - 2, GATE_LANTERN_Y, z + GATE_Z_OFFSET]} />
      <Lantern position={[x + 2, GATE_LANTERN_Y, z + GATE_Z_OFFSET]} />
      <Lantern position={[x + CAMPFIRE_LANTERN_X, CAMPFIRE_LANTERN_Y, z + CAMPFIRE_Z_OFFSET]} />
      <Lantern position={[x - 4, CORNER_LANTERN_Y, z + CORNER_Z_OFFSET]} />
      <Lantern position={[x + 4, CORNER_LANTERN_Y, z + CORNER_Z_OFFSET]} />
    </group>
  )
}

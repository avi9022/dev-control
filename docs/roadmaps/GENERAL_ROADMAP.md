...
- [ ] **GF3**: Service Groups & Categories — allow organizing services into named groups/categories (e.g., "Backend", "Frontend", "Infrastructure"), with collapsible group headers in the sidebar, bulk start/stop per group, and drag-and-drop reordering between groups
